...
//               free to drop us <br /> an email. Our staff will always be there to help you out. Donot hesitate!
//             </p>
//             </div>
...
//         <div className="flex flex-col ml-[200px] pr-[100px]">
...
//             <p>Monday-Friday: 9:00 <br /> - 22:00 <br />
//             Saturday-Sunday: 9:00 <br /> - 21:00</p>
//           </div>
//         </div>

//         {/* Get In Touch Section (Left side) */}
//         <div className="container px-5 mx-auto w-1/2">
//           <div className="lg:w-3/4 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto
...
//             <button className="bg-[#007580] text-white py-2 px-6 rounded text-lg mt-4 w-[237px]">
//               Submit
//             </button>
//           </div>
//         </div>
