  ...
  return (
    <div className='w-full flex mx-4 my-10 flex-col md:flex-row'>
      ...
      <div className='w-full md:w-1/2 grid grid-cols-2 gap-2 sm:grid-cols-1 lg:grid-cols-2 ml-4'>
        ...
        <Image src="/Image4.svg" alt="Image 2" width={312} height={312} className="w-full h-auto" />
        <Image src="/Image4.svg" alt="Image 3" width={312} height={312} className="w-full h-auto" />
        <Image src="/Image4.svg" alt="Image 4" width={312} height={312} className="w-full h-auto" />
      </div>
    </div>
  )
}
